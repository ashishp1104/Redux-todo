...
const AddTodo = () => {
  ...
  return (
    <form action="" onSubmit={addToHandler} className='space-x-3 mt-12'>
        ...
        <button type='submit' className='text-white bg-indigo-500 border-0 py-2 py-6 focus:outline-none hover:bg-indigo-600 rounded text-lg'>Add todo</button>
    </form>
  )
}
